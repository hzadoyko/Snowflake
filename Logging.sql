/**********************************************************************************
    ...
    Warn/Warning - indication that something unexpected has happened
    Error - a more serious problem prevented software from functioning properly
    Fatal/Critical - severe error(s) that may cause application termination

    python logging library = logging
**********************************************************************************/
-- Change log level
--ALTER SESSION SET LOG_LEVEL = INFO; -- Can also set on account level
